        ...
        <section className="banner-section">
            <div className="overlay">
                <div className="shape-area">
                    ...
                    <img src="assets/images/winner-cup.png" className="obj-2" alt="image" />
                </div>
                            ...
                            <div className="col-lg-6 col-md-10">
                                <div className="main-content">
                                    <div className="top-area section-text">
                                        ...
                                        <p className="xlr">The fastest, easiest way to bet on sports.NBA, Tennis & Soccer,
                                            Choose on which team to bet and win</p>
                                    </div>
                                    <div className="bottom-area">
                                        <span className="btn-border">
                                            <button type="button" className="cmn-btn reg" data-bs-toggle="modal"
    ...
    return (
        <section className="about-bitbetio">
            <div className="overlay pt-120 pb-120">
                <div className="shape-area">
                    <img src="assets/images/crypto-fanus-1.png" className="obj-1" alt="image" />
                    <img src="assets/images/crypto-fanus-2.png" className="obj-2" alt="image" />
                </div>
                <div className="container">
            ...
            <div className="overlay pt-120 pb-120">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            <div className="section-header text-center">
                                <h5 className="sub-title">Sports Escrow Bets Peer 2 Peer</h5>
                                <h2 className="title">Bets in This Game</h2>
...
export const AmazingFeature: FC = () => {
    return (
                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-lg-5 order-lg-0 order-1">
                            <div className="img-area d-rtl">
                                <img src="assets/images/affilliate-image.png" alt="image" className="max-un" />
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="section-text">
                                <h5 className="sub-title">Join forces with Bitbetio</h5>
